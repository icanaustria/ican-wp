<ul class="content-share">
	...
	<li><a href="http://twitter.com/share?url=<?php echo get_permalink(); ?>" target="_blank"><i class="fi-social-twitter large"></i></a></li>
	<li><a href="https://plus.google.com/share?url=<?php echo get_permalink(); ?>" target="_blank"><i class="fi-social-google-plus large"></i></a></li>
